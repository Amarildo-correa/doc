...
1. Leia primeiro `AGENTS.md` — é o índice único da árvore. Cada linha tem o formato:
...
`AGENTS.md` tem poucas linhas e descreve a árvore inteira; cada arquivo em `references/` é pequeno e cobre um único item. Ler nessa ordem (índice → arquivo específico) evita carregar conteúdo irrelevante na janela de contexto.

## Fonte única de verdade

O conteúdo de cada aula existe em um único lugar: o arquivo `.md` listado em `AGENTS.md`. Não há duplicação do conteúdo em nenhum outro lugar deste repositório.
